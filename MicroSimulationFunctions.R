...
for (i in 1:5)
{
  ...
  beta_class1_scenario=-5.7145
  beta_class2_scenario=-4.1903
  ...
  beta_class1_scenario=c(0,	0.0381,	0.0004,-4.6708,	0.0989,	3.6372,	0.0004,	0.0005)
  #beta_class2_scenario=c(0.1207,	0.0177,	0.00002,	-0.1254,	0.0895,	0,	0.0023,	0.0008)
  beta_class2_scenario=c(0.1207,	0.0177,	0.008,	-3.4254,	0.0895,	1.85,0.0003,	0.0008)
